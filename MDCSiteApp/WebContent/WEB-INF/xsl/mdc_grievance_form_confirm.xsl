	...
	<xsl:template match="glicApplication">
		<html>
			<HEAD>
				...
				<title>CONFIRM GRIEVANCE FORM</title>
								...
								<table height="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										...
										<td height="100%" width="424" valign="top">
											...
											<img border="0" alt="" src="images/hdr_please_review.gif" />
											<div>
													<img border="0" alt="" src="images/x.gif" />
											</div>
											<!--Main Section-->
											<span>If you need to make any changes, click the Back button to return to the form. If you are satisfied that your form is ready to send, click the Submit button.</span>
											<div>
												<img border="0" height="10" width="1" alt="" src="images/x.gif" />
											</div>
										</td>
									...
									<tr>
										...
										<td>
											<TABLE cellpadding="0" cellspacing="0" border="0" width="424" align="center">
												<TBODY>
													<TR>
													...
													<TR>
														<td colspan="5">
															<img border="0" height="5" width="20" alt="" src="images/x.gif" />
														</td>
													</TR>
													<TR>
														...
														<TD colspan="5">
															<xsl:choose>
																<xsl:when test="string-length(Description)&gt;80">
																	<TEXTAREA rows="5" cols="80" name="txtDescription" style="background-color:#ffffff;border:0px;" readonly="true">
																		<xsl:value-of select="Description" />
																	</TEXTAREA>
																</xsl:when>
																<xsl:otherwise>
																	<xsl:if test="string-length(Description)&lt;80">
																		<xsl:value-of select="Description" />
																	</xsl:if>
																</xsl:otherwise>
															</xsl:choose>
											...
											<TABLE cellpadding="0" cellspacing="0" border="0" width="424" align="center">
												<TR>
													<TD width="70%">
														<img border="0" height="1" width="10" alt="" src="images/x.gif" />
													</TD>
													<TD>
														<INPUT type="button" name="btnBack" class="button" value="   Back   " onclick="javascript:showGreivanceForm();" />
													</TD>
													<TD>
														<img border="0" height="1" width="10" alt="" src="images/x.gif" />
													</TD>
													<TD>
														<INPUT type="button" name="btnSubmit" class="button" value=" Submit " onclick="javascript:mailGrievanceDetails();" />
													</TD>
												</TR>
												<TR>
													<td colspan="4">
