								...
								<table height="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										...
										<td height="100%" width="424" valign="top">
											...
											<table cellpadding="0" cellspacing="5" width="100%">
												<tr>
													<td id="SystemMessage" class="error" align="center">
											...
											<table cellpadding="0" cellspacing="5" width="100%">
												<tr>
													<td id="SystemMessage" class="error" align="center">
														Please call the help desk or click
														<A href="javascript:void homePage()" class="generic_link">Here</A>
														to try again
													</td>
												</tr>
											</table>
										...
										<td>
											<TABLE cellpadding="0" cellspacing="0" border="0" width="424" align="center">
												<TBODY>
													...
													<TR>
														<td colspan="4">
															<img border="0" height="10" width="20" alt="" src="images/x.gif" />
														</td>
													</TR>
												</TBODY>
											</TABLE>
												...
												<tr>
													<td>
														<table border="0" cellspacing="0" cellpadding="0">
															...
															<tr>
																<td colspan="2">
																	<img border="0" height="20" alt="" src="images/x.gif" />
																</td>
															</tr>
														</table>
													</td>
